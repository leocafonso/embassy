// SYSC variant → chip cfg mapping (source: ra-data-gen/src/perimap.rs)
// v1 (RA2, no PLL):           #[cfg(any(ra2a1, ra2a2, ra2e1, ra2e2, ra2e3, ra2l1, ra2l2, ra2t1))]
// v2 (RA4M1/W1, legacy PLL):  #[cfg(any(ra4m1, ra4w1))]
// v3 (RA6M1/M2/M3/T1):        #[cfg(any(ra6m1, ra6m2, ra6m3, ra6t1))]
// v4 (RA4M2+, RA6M4+, E1/E2): #[cfg(any(ra4e1, ra4e2, ra4m2, ra4m3, ra4t1, ra6e1, ra6e2, ra6m4, ra6m5, ra6t2, ra6t3))]
// v5 (RA4L1/C1):               #[cfg(any(ra4c1, ra4l1))]
// v6 (RA8):                    #[cfg(any(ra8d1, ra8e1, ra8e2, ra8m1, ra8p1, ra8t1))]
// v7 (RA0):                    #[cfg(any(ra0e1, ra0e2))]
...
// v1 — RA2 family (no PLL)
#[cfg(any(ra2a1, ra2a2, ra2e1, ra2e2, ra2e3, ra2l1, ra2l2, ra2t1))]
mod v1;
#[cfg(any(ra2a1, ra2a2, ra2e1, ra2e2, ra2e3, ra2l1, ra2l2, ra2t1))]
pub use v1::Config;
#[cfg(any(ra2a1, ra2a2, ra2e1, ra2e2, ra2e3, ra2l1, ra2l2, ra2t1))]
pub(crate) use v1::init;

// v4 — RA4M2+, RA6M4+, RA6E1/E2 (modern PLL, no PLODIV)
#[cfg(any(ra4e1, ra4e2, ra4m2, ra4m3, ra4t1, ra6e1, ra6e2, ra6m4, ra6m5, ra6t2, ra6t3))]
mod v4;
#[cfg(any(ra4e1, ra4e2, ra4m2, ra4m3, ra4t1, ra6e1, ra6e2, ra6m4, ra6m5, ra6t2, ra6t3))]
pub use v4::{Config, PllV4Config};
#[cfg(any(ra4e1, ra4e2, ra4m2, ra4m3, ra4t1, ra6e1, ra6e2, ra6m4, ra6m5, ra6t2, ra6t3))]
pub(crate) use v4::init;
...
/// PLL VCO multiplier — register value = (multiplier × 2) − 1
#[derive(Clone, Copy, PartialEq, Eq, Debug)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum PllMul {
    Mul10_0 = 0x13,
