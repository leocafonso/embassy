...
/// Generate option_bytes.rs with OFS0/OFS1 statics derived from the chip family
/// and the selected `hoco-*` Cargo feature (or family default if none selected).
fn generate_option_bytes(out: &PathBuf, family: &str) {
    ...
    // Emit check-cfg for each hoco feature so rustc doesn't warn.
    for f in &all_hoco {
        println!(
    ...
    let (ofs1, tz, freq_str) = match family {
        // RA2: bits [14:12], mask 0xFFFF8FFF, default 48 MHz
        ...
        // RA4 + RA6 non-TZ: bits [10:9], mask 0xFFFFF9FF, default 48 MHz
        ...
        // RA6 TrustZone: bits [10:9], mask 0xFFFFF9FF, default 20 MHz, section = ofs1_sec
        "ra6e2" | "ra6m4" | "ra6m5" => {
        ...
        // RA8: bits [11:9], mask 0xFFFFF1FF, default 20 MHz
